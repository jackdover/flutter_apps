...
class GlobalInfo {
  ...
  String locale;
  num primarySwatch;
  bool isDarkBrightness = false; // false: Brightness.light, true: Brightness.dark

  GlobalInfo({this.locale, this.primarySwatch, this.isDarkBrightness});

  GlobalInfo.fromJson(Map<String, dynamic> json) {
    locale = json['locale'];
    primarySwatch = json['primarySwatch'];
    isDarkBrightness = json['isDarkBrightness'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['isDarkBrightness'] = this.isDarkBrightness;
    return data;
  }
}
