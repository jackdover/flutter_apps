class ShopCartEntity {
  ...
  ShopCartEntity({this.cartInfo, this.tabMenus, this.code, this.imageDomain, this.resultCode, this.userIdentity});

  ShopCartEntity.fromJson(Map<String, dynamic> json) {
