...
import 'detail/goods_info_page.dart';

class TabLayoutNestWidget extends StatefulWidget {
  HomeGoods homeGoods;

  TabLayoutNestWidget({Key key, @required this.homeGoods}) : super(key: key);

  @override
  _TabLayoutNestWidgetState createState() => _TabLayoutNestWidgetState();
}

class _TabLayoutNestWidgetState extends State<TabLayoutNestWidget> with SingleTickerProviderStateMixin {
