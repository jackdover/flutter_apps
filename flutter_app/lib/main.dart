...
import 'third/video_player/video_player_demo.dart';
import 'third/webview/webview_example.dart';
...
void main() {
  ...
  runApp(
    MultiProvider(
      ...
      child: MyApp(),
      // child: MaterialApp(home: WebViewExample(url:'https://flutter.cn',)),
      // child: MaterialApp(home: AKWebViewPage(url:'https://flutter.cn',title: "我是web标题",)),
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        primarySwatch: AKColor.primaryColor,
        primaryColor: AKColor.primaryColor,
        accentColor: AKColor.accentColor,
        canvasColor: AKColor.canvasColor,
    ...
    /*return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return MaterialApp(
          ...
          home: Center(child: Text('FlutterScreenUtil Demo')),
        );
      },
    );*/
  }
